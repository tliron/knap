...
import (
	...
	versioned "github.com/tliron/knap/apis/clientset/versioned"
	internalinterfaces "github.com/tliron/knap/apis/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tliron/knap/apis/listers/knap.github.com/v1alpha1"
	knapgithubcomv1alpha1 "github.com/tliron/knap/resources/knap.github.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KnapV1alpha1().Networks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KnapV1alpha1().Networks(namespace).Watch(context.TODO(), options)
			},
		},
		&knapgithubcomv1alpha1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&knapgithubcomv1alpha1.Network{}, f.defaultInformer)
}
