...
import (
	...
	"github.com/tliron/knap/apis/clientset/versioned/scheme"
...
// KnapV1alpha1Client is used to interact with features provided by the knap.github.com group.
type KnapV1alpha1Client struct {
	restClient rest.Interface
}

func (c *KnapV1alpha1Client) Networks(namespace string) NetworkInterface {
...
// NewForConfigAndClient creates a new KnapV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*KnapV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
